...
owner_name = "Vic Gorom"

# the year the restaurant was established, and the data type is integer
year_established = 2024

# price of the most popular item, and the data type is integer
popular_item_price = 149

# whether the restaurant offers delivery service or not, the data type is boolean
has_delivery = True
...
menu_prices = {"Tinuktok": 139, "Pansit Bato": 159, "Bicol Express": 149, "Kalingking": 99, "Pinakru": 99}
